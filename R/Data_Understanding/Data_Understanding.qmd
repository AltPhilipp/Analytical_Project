...
6.  Insides into `quantityModifications` with Fraud Breakdown
...
<!-- ggplotly(boxplot_scannedLineItemsPerSecond)  # Interactive version -->
<!-- ``` -->
<!-- ::: -->
...
<!-- ```{r} -->
<!-- # Density plot for scannedLineItemsPerSecond by fraud status -->
<!-- density_scannedLineItemsPerSecond <- ggplot(df, aes(x = scannedLineItemsPerSecond, fill = factor(fraud))) + -->
<!--   geom_density(alpha = 0.5) + -->
<!--   labs(title = "Density Plot of Total scannedLineItemsPerSecond by Fraud Status", -->
<!--        x = "Total scannedLineItemsPerSecond (Seconds)", -->
<!--        y = "Density", -->
<!--        fill = "Fraud Status") + -->
<!--   scale_fill_manual(values = c("0" = "steelblue", "1" = "red")) + -->
<!--   theme_minimal() -->

<!-- ggplotly(density_scannedLineItemsPerSecond)  # Interactive version -->
<!-- ``` -->
